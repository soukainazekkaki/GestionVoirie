              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{asset('images/user.png') }}" alt="responsable" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>{{ Auth::guard('responsable')->user()->name }}</h4>
                      <p class="text-secondary mb-1">Responsable de la commune {{ Auth::guard('responsable')->user()->commune }} </p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    {{ Auth::guard('responsable')->user()->name }}
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    {{ Auth::guard('responsable')->user()->commune }}
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info "  href="{{route('responsable.editprofile') }}">Modifier</a>
                    </div>
                  </div>
                </div>
              </div>
